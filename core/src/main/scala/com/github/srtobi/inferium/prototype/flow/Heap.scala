...
class HeapStateBuilder(private var cur: Heap.HeapState, private val node: Node) {
...
trait Heap {
    def newEmptyHeapState(): Heap.HeapState
    def newMergeHeapState(): Heap.MergeHeapState
