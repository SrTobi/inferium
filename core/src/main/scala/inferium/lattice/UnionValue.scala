...
case class UnionValue(isUndef: Boolean, isNull: Boolean, bool: GeneralBoolLattice, num: Option[NumberValue], strings: Set[StringValue], objs: Set[ObjLocation], refs: Set[Ref]) extends Entity {
